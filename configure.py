...
def parse_args():
    ...
    # Embeddings
    parser.add_argument("--embeddings", default='glove300', #None,
    ...
    parser.add_argument("--emb_dropout_keep_prob", default=0.6,
    ...
    parser.add_argument("--rnn_dropout_keep_prob", default=0.6,
